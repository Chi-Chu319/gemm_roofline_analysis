...
def workgroup_metrics(args, arch_specs, byte_size):
    ...
    num_iter_k = cdiv(K, BLOCK_SIZE_K)
    num_iter_stages = cdiv(K, num_stages * BLOCK_SIZE_K)
    ...
    print(f"num waves per CU: {num_pid_m * num_pid_n * ksplit // num_cus}")
    print(f"num_iter_k: {num_iter_k}")
    print(f"num_iter_stages: {num_iter_stages}")
